...
exports.injectRequestInfoOnSpan = (span, http, config) => {
    ...
    span === null || span === void 0 ? void 0 : span.log({ 'request-headers': utils_1.cloneAndSanitizeHeaders(config.headers) });
};
...
exports.injectResponseInfoOnSpan = (span, response) => {
    ...
    span === null || span === void 0 ? void 0 : span.log({ 'response-headers': utils_1.cloneAndSanitizeHeaders(response.headers) });
    ...
    if (response.headers[constants_1.ROUTER_CACHE_HEADER]) {
        span === null || span === void 0 ? void 0 : span.setTag("http.cache.router" /* HTTP_ROUTER_CACHE_RESULT */, response.headers[constants_1.ROUTER_CACHE_HEADER]);
    }
};
