...
exports.statusTrackHandler = async (ctx) => {
    var _a, _b, _c;
    (_b = (_a = ctx.tracing) === null || _a === void 0 ? void 0 : _a.currentSpan) === null || _b === void 0 ? void 0 : _b.setOperationName('builtin:status-track');
    if (!constants_1.LINKED) {
        (_c = process.send) === null || _c === void 0 ? void 0 : _c.call(process, BROADCAST_STATUS_TRACK);
    }
    ctx.body = [];
    return;
};
